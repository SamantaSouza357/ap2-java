...
public class ElementIterator<E> implements Iterator<E>{
	...
	public boolean hasNext() {
		return (cursor != null);
	} // vrifica quem é o proximo se null, retorna false.
	...
	public E next() throws NoSuchElementException {
		...
		cursor = (cursor == list.last()) ? null : list.next(cursor); // se cursor for ultimo, retorna null, senao pega o proximo
		return toReturn;
	}
	...
	// não vai fazer nada, pois é um contrato, dever ter ele implementado, por causa
	// do interator
